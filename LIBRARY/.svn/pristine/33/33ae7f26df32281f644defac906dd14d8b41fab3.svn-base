...
<div class="container">
	<div class="subTit">
      <div class="line_map">홈 > 참여마당 > 자유게시판 > 글쓰기</div>
      <div class="tit">자유게시판 글쓰기</div>
   	</div>

	<form action="/otherB/regFreeBoard" method="post" id="frBoardWrite" class="needs-validation" enctype="multipart/form-data">
