...
<div class="row">
	<div class="boardDiv col-11 text-left" >
		...
		<div class="col-12 d-grid gap-2 d-md-flex justify-content-md-end">
			<button type="button" class="btn btn-success" onclick="location.href='/member/favChk';">목록보기</button>
			<button type="button" class="btn btn-success" onclick="location.href='/member/favorBookPlanerUpdate?memId=${loginInfo.memId }&complitCode=${bookPlaner.complitCode }&bookCode=${bookPlaner.bookCode}';">수정</button>
			<button type="button" class="btn btn-success" onclick="bookPlanerDeleteInFav();">삭제</button>
